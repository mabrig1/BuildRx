    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            PDF, DOCX, XLSX, or an image — max 10MB. Text is extracted right
            away; a summary generates automatically.
          </DialogDescription>
        </DialogHeader>
        ...
        >
          ...
          <p className="text-sm font-medium">
            {isUploading ? "Uploading and extracting…" : "Click or drag a file here"}
          </p>
        </button>
      </DialogContent>
    </Dialog>
